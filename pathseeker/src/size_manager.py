...
class SizeManager(i_size_manager.ISizeManager):
    ...
    MEDIUM = size.Size(name="medium", short_name="M", space=5, tall_reach=5, long_reach=5)
    LARGE = size.Size(name="large", short_name="L", space=10, tall_reach=10, long_reach=5)
    HUGE = size.Size(name="huge", short_name="H", space=15, tall_reach=15, long_reach=10)
    GARGANTUAN = size.Size(name="gargantuan", short_name="G", space=20, tall_reach=20, long_reach=15)
    ...
    __NAME_TO_SIZE = {
        _size.get_name(): _size for _size in SIZES
    }
    __SHORT_NAME_TO_SIZE = {
        _size.get_short_name(): _size for _size in SIZES
    }
