...
class TestSize(unittest.TestCase):
    ...
    def test_get_name(
        ...
        test_size = size.Size(
            name=name, short_name=short_name, space=space, tall_reach=tall_reach, long_reach=long_reach
        )
        self.assertEqual(test_size.get_name(), name)
    ...
    def test_get_short_name(
        ...
        self.assertEqual(test_size.get_short_name(), short_name)
    ...
    def test_get_space(
        ...
        self.assertEqual(test_size.get_space(), space)
    ...
    def test_get_tall_reach(
        ...
        self.assertEqual(test_size.get_tall_reach(), tall_reach)
    ...
    def test_get_long_reach(
        ...
        self.assertEqual(test_size.get_long_reach(), long_reach)
